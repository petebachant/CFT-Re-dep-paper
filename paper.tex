...
\abstract{The performance and wake characteristics of cross-flow (vertical axis)
    turbines depend on many parameters: solidity, blade profile, blade pitch, 
    number of blades, strut drag, operational parameters such as tip speed 
    ratio---and Reynolds number.  
    Experiments were performed with a large laboratory-scale high
    solidity cross-flow turbine to investigate Reynolds number dependence of
    performance and wake transport characteristics. A key question was what an
    acceptable Reynolds number mismatch is for scaled physical model tests of
    cross-flow turbines, both from the perspective of predicting full scale 
    performance and flow dynamics, as well as numerical model validation.
    It was demonstrated that the performance of the cross-flow
