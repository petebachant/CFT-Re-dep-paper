...
\abstract{Experiments were performed with a large laboratory-scale high solidity
    ...
    wake characteristics, to establish scale thresholds for physical and numerical
    ...
    approximate average Reynolds number based on blade chord of $Re_c \approx 2
