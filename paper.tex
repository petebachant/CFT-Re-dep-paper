...
\abstract{The performance and wake characteristics of cross-flow (vertical axis)
    ...
    Reynolds number. If numerical models are validated with physical model data that
    ...
    other turbine parameters or issues with the numerical model. Experiments were
    performed with a large laboratory-scale cross flow turbine of to investigate
    Reynolds number dependence of performance and wake transport characteristics,
