...
number of blades, strut drag, operational parameters such as tip speed ratio---and Reynolds number. If numerical models are validated with physical model
...
pressure gradient on the suction side and delay separation to higher angles of
...
XFOIL viscous panel method code \cite{Drela1989}, a commonly used tool for airfoil analysis, e.g. \cite{Castelli2011, Walker2014}, implemented as part of the
open source turbine design software QBlade \cite{Marten2013}. Simulations were run for an angle of
...
\todo[inline]{Is this the peak torque coefficient or the mean power coefficient?}
