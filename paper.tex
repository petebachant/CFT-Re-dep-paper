...
regime for cross-flow turbine performance using only 2-D static airfoil
characteristics, i.e., Reynolds number scaling of the peak $C_T$ computed this
...
become significant to the wake dynamics as Reynolds number is decreased below
$Re_D \sim 10^4$.
...
reasonably low, may be increasing flow through the turbine compared with a free
