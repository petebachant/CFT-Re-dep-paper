...
with model predictions matching full scale observations are caused by Reynolds
number effects or issues with the numerical model itself. One might also obtain
different predictions for scaled systems due to modified physics at lower
