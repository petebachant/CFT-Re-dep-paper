...
\abstract{Experiments were performed with a large laboratory-scale high solidity
    ...
    \times 10^5$.~A simple model that calculates the peak torque coefficient from
    static foil data and cross-flow turbine kinematics was shown to be a reasonable
    predictor for Reynolds number dependence of an actual cross-flow turbine
    operating under dynamic conditions. Mean velocity and turbulence measurements in
    the near-wake showed subtle differences over the range of $Re$
